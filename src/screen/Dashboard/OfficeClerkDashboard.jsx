...
class OfficeClerkDashboard extends Component {
  ...
  render() {
    return (
      <div data-testid="officeclerkdashboard">
        <NavBar />
          ...
          <div className="row">
            <div className="col-lg-12" align="center">
              ...
              <p>
                ...
                <Link to={"/office-clerk/new-damage"} data-testid="addnewdamage">
                  <a href="" className="btn btn-sq-lg btn-success p-4 m-4">
                    <i className="fa fa-plus-square fa-5x"></i><br />
                    New Damage Items
                  </a>
                </Link>
                <Link to={"/office-clerk/pending-damage"} data-testid="markrepair">
                  <a href="" className="btn btn-sq-lg btn-success p-4 m-4">
                    <i className="fa fa-check-square-o fa-5x"></i><br />
                    Mark As Repair
                  </a>
                </Link>
                <Link to={"/office-clerk/old-damage"} data-testid="repairhistrory">
                  <a href="" className="btn btn-sq-lg btn-success p-4 m-4">
                    <i className="fa fa-history fa-5x"></i><br />
                    Repair History
                  </a>
                </Link>
                <Link to={"/office-clerk/item-list"} data-testid="checkavailability">
                  <a href="" className="btn btn-sq-lg btn-success p-4 m-4">
