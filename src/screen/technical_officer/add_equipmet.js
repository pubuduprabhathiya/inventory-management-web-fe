...
const AddEquipment = () => {
    ...
    return (
        <Box sx={{
            ...
            <Button sx={{ width: 300, m: 3 }} variant="contained" component="label" color={imgURLerror ? "error" : "success"}>Upload Image
                <input
                    type="file"
                    hidden
                    accept="image/*"
            ...
            <FormControl sx={{ m: 1, minWidth: 200 }}>
                <Button sx={{ width: 300, m: 3 }} variant="contained" color="success" onClick={() => sumbitData()} disabled={submit}>Submit</Button>
